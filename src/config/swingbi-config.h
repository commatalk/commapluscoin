/* src/config/commapluscoin-config.h.  Generated from commapluscoin-config.h.in by configure.  */
/* src/config/commapluscoin-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_NAME "CommaPlusCoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "CommaPlusCoin Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "commapluscoin"
