...
//! Burn address
//static const string BURN_ADDRESS("SVSJ1tT1iTXAs1Nd4uJb7VgdS7Q9mJctig");
//static const string BURN_ADDRESS("SNZFWfVZG8Le8F34PBAdFfpLhwPHYh1imb");
static const string BURN_ADDRESS("CSgbyADd8hom5h3rT4N6KwUcuvciV8ZzHi");
...
public:
    ...
    bool CommitTransaction(CWalletTx& wtxNew, CReserveKey& reservekey, std::string strCommaPlusCoinnd = "tx");
...
public:
    ...
    void RelayWalletTransaction(std::string strCommaPlusCoinnd = "tx");
