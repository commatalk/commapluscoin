...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop CommaPlusCoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "CommaPlusCoin server stopping";
}
...
static const CRPCCommaPlusCoinnd vRPCCommaPlusCoinnds[] =
    {
        ...
        /* CommaPlusCoin features */
        {"commapluscoin", "masternode", &masternode, true, true, false},
        {"commapluscoin", "listmasternodes", &listmasternodes, true, true, false},
        {"commapluscoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"commapluscoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"commapluscoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"commapluscoin", "masternodedebug", &masternodedebug, true, true, false},
        {"commapluscoin", "startmasternode", &startmasternode, true, true, false},
        {"commapluscoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"commapluscoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"commapluscoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"commapluscoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"commapluscoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"commapluscoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"commapluscoin", "mnbudget", &mnbudget, true, true, false},
        {"commapluscoin", "preparebudget", &preparebudget, true, true, false},
        {"commapluscoin", "submitbudget", &submitbudget, true, true, false},
        {"commapluscoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"commapluscoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"commapluscoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"commapluscoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"commapluscoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"commapluscoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"commapluscoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"commapluscoin", "checkbudgets", &checkbudgets, true, true, false},
        {"commapluscoin", "mnsync", &mnsync, true, true, false},
        {"commapluscoin", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> commapluscoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:34521/\n";
}
