...
/** Utility functions used by the CommaPlusCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render CPC addresses in monospace font
...
// Parse "commapluscoin:" URI into recipient object, return true on successful parsing
...
/** Get save filename, mimics QFileDialog::getSaveFileName, except that it appends a default suffix
      ...
      @param[in] filter  Filter specification such as "CommaPlusCoin Separated Files (*.csv)"
