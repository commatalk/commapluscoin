...
// Copyright (c) 2015-2018 The COMMAPLUSCOIN developers
                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("COMMAPLUSCOIN Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a COMMAPLUSCOIN address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and commapluscoin: URIs)"));
   ...
   // privacyAction->setStatusTip(tr("Privacy Actions for zCPC"));
  ...
  //  governanceAction->setCheckable(true);
   ...
   // connect(governanceAction, SIGNAL(triggered()), this, SLOT(gotoGovernancePage()));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About COMMAPLUSCOIN Core"), this);
    aboutAction->setStatusTip(tr("Show information about COMMAPLUSCOIN Core"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/qt-project.org/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for COMMAPLUSCOIN"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your COMMAPLUSCOIN addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified COMMAPLUSCOIN addresses"));
...
//    openMNConfEditorAction->setStatusTip(tr("Open Masternode configuration file"));
    ...
    openAction->setStatusTip(tr("Open a COMMAPLUSCOIN: URI or payment request"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("COMMAPLUSCOIN Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to COMMAPLUSCOIN network", "", count));
}
...
{
    QString strTitle = tr("COMMAPLUSCOIN Core"); // default title
