...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("CommaPlusCoin Core"),
     ...
     * override -datadir in the commapluscoin.conf file in the default data directory
     * (to be consistent with commapluscoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
