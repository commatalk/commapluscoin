...
In order to support loading of multiple wallets in commapluscoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is commapluscoin.cpp.
...
Changes to commapluscoin.cpp
----------------------
commapluscoin.cpp is the entry point into commapluscoin-qt, and as such, will require some minor modifications to provide hooks for
