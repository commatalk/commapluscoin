...
Intro
-----
CommaPlusCoin (CPC) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. CommaPlusCoin utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run commapluscoin-qt.exe.

CommaPlusCoin Core is the original CommaPlusCoin client and it builds the backbone of the network.
However, it downloads and stores the entire history of CommaPlusCoin transactions;
