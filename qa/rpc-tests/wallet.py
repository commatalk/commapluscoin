...
#   c) node1 mines 32 blocks, so now node 0 has 500000CPC, node 1 has 4250CPC, node2 has none.
#   d) node0 sends 601 CPC to node2, in two transactions (301 CPC, then 300 CPC).
