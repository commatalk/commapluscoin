Contributing to CommaPlusCoin Core
==================================

The CommaPlusCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the CommaPlusCoin Core project, and is not to be
confused with overall CommaPlusCoin Network Protocol consensus changes.

Whether a pull request is merged into CommaPlusCoin Core rests with the project merge
...
Patches that change CommaPlusCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the CommaPlusCoin consensus, it must have been
...
The project leader is the release manager for each CommaPlusCoin Core release.
